...
// Map internal feature keys to user-friendly labels
const friendlyLabels = {
  age: "Age",
  annual_income: "Annual Income",
  employment_years: "Employment Years",
  derogatory_marks: "Derog Marks",
  inquiries_last6m: "Inquiries (6m)",
  inquiries_finance_24m: "Finance Inquiries (24m)",
  total_accounts: "Total Accounts",
  active_accounts: "Active Accounts",
  high_credit_util_75: "High Util ≥75% (0/1)",
  util_50_plus: "Util ≥50% (0/1)",
  balance_high_credit_pct: "Balance / High Credit %",
  satisfied_pct: "Satisfied %",
  delinquency_30_60_24m: "30–60d Delinq (24m)",
  delinquency_90d_24m: "90d Delinq (24m)",
  delinquencies_60d: "60d Delinquencies",
  chargeoffs_last24m: "Chargeoffs (24m)",
  derog_or_bad_cnt: "Derog / Bad Count",
  accounts_open_last24m: "Accounts Open (24m)",
...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <p>
        Enter applicant financial & credit attributes. Leave blank to use
        defaults.
      </p>
      <form
      ...
      >
        {Object.keys(initialState).map((field) => (
          <div key={field} style={{ display: "flex", flexDirection: "column" }}>
            <label style={{ fontSize: 12, fontWeight: 600 }} title={field}>
            ...
            <input
              ...
              placeholder={friendlyLabels[field] || field}
